...
class CustomerChurnAnalyzer:
    ...
    def model_evaluation(self):
        ...
        for i, model in enumerate(self.results.keys()):
            values = [self.results[model][metric.lower().replace('-', '_')] for metric in metrics]
        ...
        # Subplot 4: Feature importance for best model (if tree-based)
        plt.subplot(2, 2, 4)
    ...
    def run_complete_analysis(self):
        ...
        print("Check the generated plots for detailed visualizations.")
